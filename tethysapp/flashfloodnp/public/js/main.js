...
myApp.layerswitcher = function () {
    ...
    img.setAttribute("src", "/static/flashfloodnp/images/layers.svg");
...
myApp.AddLegend = function () {
    ...
    var labels = ["20-Year return period ", "10-Year return period ", "2-Year return period ", "Normal drainage"];
    var grades = [4, 3, 2, 1];
...
myApp.AddLayers = async function () {
    ...
    let datasource = 'https://tethys.icimod.org:8443/geoserver/ows';
    let LegendSource = 'https://tethys.icimod.org:8443/geoserver/ows?Service=WMS&REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LEGEND_OPTIONS=forceLabels:off&LAYER='
    ...
    var CountryBoundary = new ol.layer.Tile({
        ...
        title: 'Outline',
        visible: true,
        legendPath: LegendSource + 'Nepal:outline',
        source: new ol.source.TileWMS({
            url: datasource,
            hidpi: false,
            params: {
                'VERSION': '1.1.1',
                'LAYERS': 'Nepal:outline',
                'TILED': true
            },
    ...
    myApp.HiwatRiverWMSSource = new ol.source.TileWMS({
        url: datasource,
        params: {
            'LAYERS': 'hydroviewer:nepalriver', 'TILED': true
        },
        serverType: 'geoserver',
        crossOrigin: 'anonymous'
    });
...
myApp.ajaxCall = function () {
    ...
    $.ajax({
        ...
        "success": function (data) {
            ...
            var an2 = "2-yr: " + Math.round(json_response.return_2 * 100) / 100;
            ...
            if (url) {
                fetch(url)
                    ...
                    .then(function (html) {
                        ...
                        myApp.Current_comid = parsedJson.features[0].properties.linkno;
                        $('#selForcastDate').val(myApp.DefaultForcastDate);
                        myApp.ajaxCall();
                    });
            }
